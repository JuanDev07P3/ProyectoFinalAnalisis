...
public class MenuPrincipalForm extends javax.swing.JFrame {
    ...
    private void configurarMenuSegunRol(String rol) {
        ...
        if (rolNormalizado.equals("ADMIN") || rolNormalizado.equals("ADMINISTRADOR")) {
            ...
            menuItemEnvioCorreos.setEnabled(true);
        }
    ...
    private void agregarListenersAMenu() {
        ...
        menuItemDetalleCompras.addActionListener(e -> {
            ...
            this.dispose();
                ...
                menuItemEnvioCorreos.addActionListener(e -> {
            EnvioCorreos form = new EnvioCorreos();
            form.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
            form.setLocationRelativeTo(this);
            form.setVisible(true);
    ...
    private void initComponents() {
        ...
        menuItemEnvioCorreos = new javax.swing.JMenuItem();
        ...
        menuItemEnvioCorreos.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        menuItemEnvioCorreos.setText("Enviar Correo");
        menuProcesos.add(menuItemEnvioCorreos);
...
int confirmacion = JOptionPane.showConfirmDialog(
    ...
    private javax.swing.JMenuItem menuItemEnvioCorreos;
