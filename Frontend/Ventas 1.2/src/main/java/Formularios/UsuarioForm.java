...
public class UsuarioForm extends javax.swing.JFrame {
    ...
    public UsuarioForm() {
        ...
        configurarTabla();
        cargarUsuarios();
        inicializarComboRol(); // <-- aquí
        agregarEventos();
        cambiarEstadoBotones(true);
        aplicarHover(btEliminar, new Color(220, 53, 69), new Color(253, 153, 0));
        aplicarHover(btAgregar, new Color(40, 167, 69), new Color(253, 153, 0));
        ...
        TblUsuarios.getSelectionModel().addListSelectionListener(e -> {
            if (!e.getValueIsAdjusting()) {
                ...
                if (fila >= 0) {
                    ...
                    ComboRol.setSelectedItem((String) tableModel.getValueAt(fila, 3));
                }
            }
        });
...
btAgregar.addActionListener(e -> {
    ...
    btAgregar.setEnabled(true);// Deshabilitar los botones al iniciar la operación
    String nombre = txtNombre.getText().trim();
    String contra = txtContra.getText().trim();
    String rol = ComboRol.getSelectedItem() != null ? ComboRol.getSelectedItem().toString() : "";

    boolean camposValidos = true;

    if (rol.equals("Seleccione el rol de usuario")) {
        lblRolError.setText("Debe seleccionar un rol válido.");
        lblRolError.setVisible(true);
        camposValidos = false;
    } else {
        lblRolError.setVisible(false); // Oculta si es válido
    }
    ...
    if (exito) {
        ...
        cambiarEstadoBotones(true);  // Habilitar los botones al finalizar la operación
...
cambiarEstadoBotones(false);
    ...
    private void limpiarCampos() {
        txtNombre.setText("");
        txtContra.setText("");
        ComboRol.setSelectedIndex(0); // Limpia la selección del ComboBox
        selectedUsuarioId = -1;
        TblUsuarios.clearSelection();
    }
    private void inicializarComboRol() {
    ComboRol.removeAllItems();
    ComboRol.addItem("Seleccione el rol de usuario");
    ComboRol.addItem("ADMIN");
    ComboRol.addItem("VENDEDOR");
    ComboRol.setSelectedIndex(0);
}
    private void cambiarEstadoBotones(boolean habilitar) {
    btAgregar.setEnabled(habilitar);
    btEditar.setEnabled(habilitar);
    btEliminar.setEnabled(habilitar);
    btLimpiar.setEnabled(habilitar);
}

        private void aplicarHover(javax.swing.JButton boton, java.awt.Color colorHover, java.awt.Color colorOriginal) {
    ...
    private void initComponents() {
        ...
        lblRolError = new javax.swing.JLabel();
        lblRolError2 = new javax.swing.JLabel();
        ...
        lblRolError1 = new javax.swing.JLabel();
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 153, 0), 3), "USUARIOS", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        ComboRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Seleccione el rol de usuario correspondiente...", "ADMIN", "VENDEDOR" }));

        lblRolError.setForeground(new java.awt.Color(255, 51, 51));

        lblRolError2.setForeground(new java.awt.Color(255, 51, 51));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(txtContra, javax.swing.GroupLayout.DEFAULT_SIZE, 474, Short.MAX_VALUE)
                ...
                .addComponent(lblRolError2, javax.swing.GroupLayout.PREFERRED_SIZE, 60, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(136, Short.MAX_VALUE))
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addGap(442, 442, 442)
                    .addComponent(lblRolError, javax.swing.GroupLayout.PREFERRED_SIZE, 165, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblRolError2, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addContainerGap())
            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(jPanel2Layout.createSequentialGroup()
                    .addGap(75, 75, 75)
                    .addComponent(lblRolError, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                .addGap(104, 104, 104)
                .addComponent(btAgregar, javax.swing.GroupLayout.PREFERRED_SIZE, 153, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(101, 101, 101)
                .addComponent(btEditar, javax.swing.GroupLayout.PREFERRED_SIZE, 136, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(87, 87, 87)
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 153, 0), 3), "Tabla Usuarios", javax.swing.border.TitledBorder.LEFT, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 1, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        lblRolError1.setForeground(new java.awt.Color(255, 51, 51));
    ...
    private javax.swing.JLabel lblRolError;
    private javax.swing.JLabel lblRolError1;
    private javax.swing.JLabel lblRolError2;
